      ...
      `}>
        <div className="flex flex-col items-center gap-3 md:gap-4 w-full max-w-[460px] px-6">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 w-full">
            <BannerButton label="MARATHON" delay={100} visible={showUI} />
            <BannerButton label="RULEBOOK" delay={200} visible={showUI} />
          </div>

          <div className="grid grid-cols-2 gap-3 md:gap-4 w-full">
            <BannerButton label="PAY HERE" delay={300} visible={showUI} />
            <BannerButton label="SCHEDULE" delay={400} visible={showUI} />
          </div>

          <div className="w-full mt-1 md:mt-2">
            <BannerButton label="REGISTER" delay={520} visible={showUI} primary />
          </div>
...
function BannerButton({ label, href = '#', delay, visible, primary }) {
  return (
    <a 
      href={href} 
      className={`
